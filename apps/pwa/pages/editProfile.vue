  ...
  <div class="flex justify-start pt-4 pl-4">
    <NuxtLink to="/profile">
      <button class="btn rounded-full min-h-fit p-3 h-fit">
        <i
          class="bx bx-left-arrow-alt text-2xl"
        />
      </button>
    </NuxtLink>
  </div>
  ...
  <div v-if="userInfos" class="w-full mx-auto">
    <form class="flex flex-col lg:grid lg:grid-cols-2 gap-4 px-12 lg:px-24 my-8 text-left" @submit="updateUser($event)">
      ...
      <div class="form-control">
        ...
        <input
          id="address" name="address" type="text" autocomplete="address-line1" placeholder="Address"
      ...
      <div class="form-control">
        ...
        <input
          id="city" name="city" class="input" placeholder="City" type="text" autocomplete="address-level2"
      ...
      <div class="form-control">
        ...
        <input
          id="postcode" class="input" name="postcode" placeholder="Postcode" type="text"
      ...
      <div class="form-control lg:col-span-full">
        ...
        <input
          id="password_confirmation" type="password" class="input" placeholder="Confirmer le mot de passe"
          name="password_confirmation"
        >
      </div>
      <button class="btn btn-neutral lg:col-span-full">
        Edit
      </button>
    </form>
  </div>
